...
if(timeoutcount == 10){
	...
	timeoutcount = 0;
		...
		IFSCLR(0) = 0x100; 	// rensrar flaggan
}
}
...
T2CONSET = 0X70;	// anävnder set register för t2con för att sätta prescalling till 1:256 
			// (70 = 0111 0000)
...
//enablar (startar )interrupts
IECSET(0) = 0x100;		//sätter till 1 för enebla
